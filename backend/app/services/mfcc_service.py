...
class MFCCExtractor:
    ...
    def extract_features(self, audio_path: str, visualize: bool = False):
        """
        Process an audio file to calculate MFCCs from a speech signal.
        Returns the MFCC matrix which can later be stored in a Pinecone database.
        """
        ...
        # Step 4: Framing
        # Break the audio signal into small frames.
        ...
        # Step 5: Windowing
        # Apply a Hamming window to each frame to minimize discontinuities at the edges.
